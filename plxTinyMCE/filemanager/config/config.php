...
$image_resizing = ($_SESSION['spxtynimce']['filemanager']['image_resizing'] == '1' ? true : false);

$image_max_width = intval ($_SESSION['spxtynimce']['filemanager']['image_width']);
$image_max_height = intval ($_SESSION['spxtynimce']['filemanager']['image_height']);

//echo ("delete file=".$_SESSION['spxtynimce']['filemanager']['deletefiles']);



$upload_files = ($_SESSION['spxtynimce']['filemanager']['uploadfiles'] == '1' ? true : false);
$rename_files = ($_SESSION['spxtynimce']['filemanager']['renamefiles'] == '1' ? true : false);
$delete_files = ($_SESSION['spxtynimce']['filemanager']['deletefiles'] == '1' ? true : false);

$create_folders = ($_SESSION['spxtynimce']['filemanager']['createfolders'] == '1' ? true : false);
$rename_folders = ($_SESSION['spxtynimce']['filemanager']['renamefolders'] == '1' ? true : false);
$delete_folders = ($_SESSION['spxtynimce']['filemanager']['deletefolders'] == '1' ? true : false);

$hidden_folders = array("articles","commentaires","configuration","statiques",".thumbs","file.thumbs");
$hidden_files = array("index.html","index.htm");

$aviary_active=$_SESSION['spxtynimce']['filemanager']['filemanger_cle_aviary'];
$aviary_key=$_SESSION['spxtynimce']['filemanager']['filemanger_secret_aviary'];
$aviary_secret=$_SESSION['spxtynimce']['filemanager']['filemanger_use_aviary'];
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => $_SESSION['spxtynimce']['upload_dir'],
	...
	|
	*/
	'current_path' => $_SESSION['spxtynimce']['current_path'],
	...
	* AVIARY config
	*******************/
	'aviary_active'                           => $aviary_active,
	'aviary_apiKey'                           => $aviary_key,
	'aviary_language'                         => "en",
	'aviary_theme'                            => "light",
	'aviary_tools'                            => "all",
	'aviary_maxSize'                          => "1400",
