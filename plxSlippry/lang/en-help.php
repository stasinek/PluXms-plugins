...
- cocher le plugin Slippry et dans le déroulant "Pour la sélection", sélectionner le menu "Activer"

Configuration du diaporama Slippry
- Aller dans le menu Paramètres > Plugins, et cliquer sur le lien Configuration du plugin Slippry

Pour ajouter des images au diaporama
- aller dans le gestionnaire des médias
- cocher les images à ajouter dans le diaporama
- dans le déroulant "Pour la sélection", sélectionner le menu Slippry > Ajouter au diaporama

Activation et personnalisation des images du diaporama
- allez dans le menu Slippry (dans le bandeau des menus de l'administration)
...
<?php echo plxUtils::strCheck('<?php eval($plxShow->callHook("Slippry")) ?>') ?>
</div>
