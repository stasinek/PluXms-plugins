  ...
  private function EncodeFile($path, $encoding = 'base64') {
    try {
      ...
      if (PHP_VERSION < 6) {
        ...
        ini_set ("magic_quotes_runtime", 0);//set_magic_quotes_runtime(0);
      }
      $file_buffer  = file_get_contents($path);
      $file_buffer  = $this->EncodeString($file_buffer, $encoding);
      if (PHP_VERSION < 6) { ini_set ("magic_quotes_runtime", $magic_quotes); }//set_magic_quotes_runtime($magic_quotes);
      return $file_buffer;
    } catch (Exception $e) {
      $this->SetError($e->getMessage());
      return '';
