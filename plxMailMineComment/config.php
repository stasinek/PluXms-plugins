...
if (!empty($_POST)) {
	...
	header('Location: parametres_plugin.php?p=plxMailMineComment');
	exit;
}
...
?>
<form id="form_plxMailMineComment" action="parametres_plugin.php?p=plxMailMineComment" method="post">
	<fieldset>
