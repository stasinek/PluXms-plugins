...
class plxRescueData extends plxPlugin {
	...
	public function AdminTopEndHead() {
		echo "\n";
		echo '<script type="text/javascript" src="'.PLX_PLUGINS.'plxRescueData/sisyphus/jquery-1.7.1.min.js"></script>'."\n";
		echo '<script type="text/javascript" src="'.PLX_PLUGINS.'plxRescueData/sisyphus/jquery.jnotify.min.js"></script>'."\n";
		echo '<link rel="stylesheet" type="text/css" href="'.PLX_PLUGINS.'plxRescueData/sisyphus/jquery.jnotify.min.css" media="screen" />'."\n";
		echo '<script type="text/javascript" src="'.PLX_PLUGINS.'plxRescueData/sisyphus/sisyphus.min.js"></script>'."\n";
	}
