<?php
/**
 * Plugin plxCoinSlider
 * @author	Stephane F
 **/

include(dirname(__FILE__).'/lib/class.plx.coinslider.php');

class plxCoinSlider extends plxPlugin {
	...
	public function ThemeEndHead() {
		echo '<link rel="stylesheet" type="text/css" href="'.PLX_PLUGINS.'plxCoinSlider/coin-slider/coin-slider-styles.css" media="screen" />';
		echo '
<style type="text/css">
...
if (typeof jQuery == "undefined") {
	document.write(\'<script type="text\/javascript" src="'.PLX_PLUGINS.'plxCoinSlider\/coin-slider\/jquery.min.js"><\/script>\');
}
</script>';
		}
			echo '
<script type="text/javascript" src="'.PLX_PLUGINS.'plxCoinSlider/coin-slider/coin-slider.min.js"></script>
<script type="text/javascript">
