...
<?php echo htmlspecialchars("<?php eval(\$plxShow->callHook('AllArchive')) ?>") ?>
</p>
...
<p style="color:#000;font-size:12px; background:#fff; padding: 10px 20px 20px 20px; border:1px solid #efefef">
<?php echo htmlspecialchars("<?php eval(\$plxShow->callHook('AllArchive', '<a href=\"#archives_url\" class=\"#archives_status\" title=\"#archives_name\">#archives_name</a>')) ?>") ?>
</p>
<?php $plxPlugin->lang('L_EXAMPLE') ?> 2:<br />
<p style="color:#000;font-size:12px; background:#fff; padding: 10px 20px 20px 20px; border:1px solid #efefef">
<?php echo htmlspecialchars("<?php eval(\$plxShow->callHook('AllArchive', '<a href=\"#archives_url\" class=\"#archives_status\" title=\"#archives_name\">".$plxPlugin->getLang('L_MY_ARCHIVES')."</a>')) ?>") ?>
</p>
...
<?php $plxPlugin->lang('L_EXAMPLE') ?> 1:<br />
<p style="color:#000;font-size:12px; background:#fff; padding: 10px 20px 20px 20px; border:1px solid #efefef">
<?php echo htmlspecialchars("<?php eval(\$plxShow->callHook('AllArchive', array('by_category', 'desc'))) ?>") ?>
</p>
<?php $plxPlugin->lang('L_EXAMPLE') ?> 2:<br />
<p style="color:#000;font-size:12px; background:#fff; padding: 10px 20px 20px 20px; border:1px solid #efefef">
<?php echo htmlspecialchars("<?php eval(\$plxShow->callHook('AllArchive', array('by_author', 'asc'))) ?>") ?>
</p>
<?php $plxPlugin->lang('L_EXAMPLE') ?> 3:<br />
<p style="color:#000;font-size:12px; background:#fff; padding: 10px 20px 20px 20px; border:1px solid #efefef">
<?php echo htmlspecialchars("<?php eval(\$plxShow->callHook('AllArchive', array('by_year', 'desc', '<a href=\"#archives_url\" class=\"#archives_status\" title=\"#archives_name\">#archives_name</a>'))) ?>") ?>
</p>
<?php $plxPlugin->lang('L_EXAMPLE') ?> 4:<br />
<p style="color:#000;font-size:12px; background:#fff; padding: 10px 20px 20px 20px; border:1px solid #efefef">
<?php echo htmlspecialchars("<?php eval(\$plxShow->callHook('AllArchive', array('by_year', 'asc', '<a href=\"#archives_url\" class=\"#archives_status\" title=\"#archives_name\">".$plxPlugin->getLang('L_MY_ARCHIVES')."</a>'))) ?>") ?>
</p>
