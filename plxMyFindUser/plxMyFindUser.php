...
class plxMyFindUser extends plxPlugin {
	...
	if (typeof jQuery == 'undefined') {
		document.write('<script type="text\/javascript" src="<?php echo PLX_PLUGINS ?>plxMyFindUser\/jquery.min.js"><\/script>');
	}
	/* ]]> */
	</script>
...
<p style="text-align:right">
	...
	<img style="display:none" id="imgDeleteFilter" src="<?php echo PLX_PLUGINS ?>plxMyFindUser/cancel.gif" alt="<?php $this->lang('L_LABEL_DELETE_FILTER') ?>" title="<?php $this->lang('L_LABEL_DELETE_FILTER') ?>" />
</p>
